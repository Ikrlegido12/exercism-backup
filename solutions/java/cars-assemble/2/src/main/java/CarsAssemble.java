public class CarsAssemble {
    ...
    public double productionRatePerHour(int speed) {
        if (speed < 1 || speed > 10) {
            return 0.0; // Invalid speed, return 0 production
        }
    ...
    public int workingItemsPerMinute(int speed) {
        ...
        // Convert hourly production to per minute and round down to the nearest whole number
        return (int) Math.floor(productionPerHour / 60);
    }
}

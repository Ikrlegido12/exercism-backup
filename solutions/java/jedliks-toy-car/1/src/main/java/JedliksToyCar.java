public class JedliksToyCar {
    ...
    public static JedliksToyCar buy() {
        System.out.println("Buying a brand-new remote controlled car!");
        batteryPercentage = 100; // Cars start with full batteries
        distanceDriven = 0; // Cars start with 0 meters driven
    ...
    public void drive() {
        if (batteryPercentage > 0) {
            distanceDriven += 20; // Each drive covers 20 meters
            batteryPercentage -= 1; // Each drive drains 1% of the battery
        }
    }
}
